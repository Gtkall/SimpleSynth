...
import {
  ...
  StatefulEvent,
  WindowState,
} from 'src/app/interfaces/stateful.interface';
...
export class WindowComponent implements OnInit, OnDestroy {
  ...
  @Output()
  windowStateChanged: EventEmitter<StateChangeByID> = new EventEmitter();
  ...
  loadComponent(componentItem: ComponentItem) {
    ...
    const componentRef = viewContainerRef.createComponent<NodeLikeComponent>(
      componentFactory
    );
  ...
  onMinimize(): void {
     ...
     */
    const el = this.appAnchorhost.viewContainerRef.element.nativeElement
      .parentElement;
